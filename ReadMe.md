...
import fs from "fs";
import { renderStatsCard } from "./src/cards/stats-card.js"; // Use your local renderer
...
const svg = renderStatsCard(mockStats, {
  ...
  border_color: "f34b7d",
  theme: "radical",
  custom_title: "HG CHEATS' GitHub Stats",
  border_radius: 12,
});

fs.writeFileSync("hgcheats-stats.svg", svg);
console.log("Offline SVG created: hgcheats-stats.svg");
